...
export default async function HabitatsPage() {
  ...
  return (
    <main className="flex flex-col bg-red-50 w-full">
      <div className="flex flex-col w-[90%] mx-auto px-10 mt-10">

        <div className="flex justify-between">
          <h1 className="text-4xl lg:text-6xl text-green-950 font-serif font-bold">Habitats</h1>

          <a href="/sanctuary-map.pdf" download className="flex items-center gap-2 bg-green-900 hover:bg-green-500 text-white font-bold py-2 px-4 rounded mr-8">
            💾 Download PDF
          </a>
        ...
        <div className= "flex justify-between my-5">
          ...
          <div>
            <Image src="/sanctuary-map.png" alt="Sanctuary map" width={800} height={600} />
          </div>
        </div>
